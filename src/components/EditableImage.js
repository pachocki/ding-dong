...
export default function EditableImage({type,src,onChange,className,editable=false}) {
  ...
  let extraClasses = '';
  if (isFileNearby && !isFileOver) extraClasses += ' bg-slate-400 opacity-40';
  if (isFileOver) extraClasses += ' bg-blue-600 opacity-90';
  ...
  return (
    ...
    >
      <div className={"bg-slate-800 overflow-hidden rounded-xl text-white relative"}>
